...
public class MecanumDrivetrain extends SubsystemBase {
    ...
    public MecanumDrivetrain(MotorEx frontLeft,MotorEx backLeft, MotorEx frontRight, MotorEx backRight) {
    ...
    public MecanumDrivetrain(HardwareMap hardwareMap, final String frontLeftName, String backLeftName, String frontRightName, String backRightName) {
